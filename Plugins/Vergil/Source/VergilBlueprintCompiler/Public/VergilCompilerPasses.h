...
class VERGILBLUEPRINTCOMPILER_API FVergilTypeResolutionPass final : public IVergilCompilerPass
{
public:
	virtual FName GetPassName() const override;
	virtual bool Run(const FVergilCompileRequest& Request, FVergilCompilerContext& Context, FVergilCompileResult& Result) const override;
...
class VERGILBLUEPRINTCOMPILER_API FVergilNodeLoweringPass final : public IVergilCompilerPass
{
public:
	virtual FName GetPassName() const override;
	virtual bool Run(const FVergilCompileRequest& Request, FVergilCompilerContext& Context, FVergilCompileResult& Result) const override;
...
class VERGILBLUEPRINTCOMPILER_API FVergilConnectionLegalityPass final : public IVergilCompilerPass
{
public:
	virtual FName GetPassName() const override;
	virtual bool Run(const FVergilCompileRequest& Request, FVergilCompilerContext& Context, FVergilCompileResult& Result) const override;
...
class VERGILBLUEPRINTCOMPILER_API FVergilPostCompileFinalizePass final : public IVergilCompilerPass
{
public:
	virtual FName GetPassName() const override;
	virtual bool Run(const FVergilCompileRequest& Request, FVergilCompilerContext& Context, FVergilCompileResult& Result) const override;
