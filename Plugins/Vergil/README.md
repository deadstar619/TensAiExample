...
- The current inspection JSON formats are `Vergil.GraphDocument`, `Vergil.DocumentDiff`, `Vergil.Diagnostics`, `Vergil.CompileResult`, `Vergil.CommandPlanPreview`, `Vergil.ReflectionSymbol`, `Vergil.ReflectionDiscovery`, `Vergil.AgentResponse`, and `Vergil.AgentAuditEntry`, each at version `1`, plus `Vergil.AgentRequest` at version `2`. Persisted agent audit logs currently use the separate on-disk wrapper format `Vergil.AgentAuditLog` at version `1`.
...
- `VGR-1001`, `VGR-1002`, `VGR-1003`, `VGR-1004`, `VGR-1005`, `VGR-1006`, `VGR-1007`, `VGR-1008`, `VGR-1009`, `VGR-1010`, `VGR-2001`, `VGR-2002`, `VGR-2003`, `VGR-2004`, `VGR-3001`, `VGR-3002`, `VGR-3003`, `VGR-3004`, `VGR-3005`, `VGR-3006`, `VGR-3007`, `VGR-3008`, `VGR-4001`, `VGR-4002`, `VGR-4003`, `VGR-4004`, `VGR-4005`, `VGR-4006`, `VGR-4007`, `VGR-4008`, `VGR-4009`, `VGR-5001`, `VGR-5002`, `VGR-5003`, `VGR-5004`, `VGR-5005`, `VGR-5006`, `VGR-5007`, `VGR-5008`, `VGR-6001`, `VGR-6002`, `VGR-6003`, `VGR-6004`, `VGR-6005`, `VGR-7001`, `VGR-7002`, `VGR-7003`, `VGR-7004`, `VGR-7005`, `VGR-7007`, `VGR-8001`, `VGR-8002`, `VGR-8003`, `VGR-8004`, `VGR-8005`, `VGR-8006`, `VGR-9004`, `VGR-9007`, and `VGR-9010` are complete.
...
- `K2.AsyncAction.*` now uses a fixed `FactoryClassPath` metadata contract plus factory-function descriptor suffix over the real `UE_5.7` `UK2Node_AsyncAction` surface, exposing visible factory inputs plus delegate exec/data outputs while intentionally excluding hidden pins such as `WorldContextObject` and dedicated async-node families.
- `K2.AIMoveTo` and `K2.PlayMontage` now use dedicated specialized async-task handlers over the real `UE_5.7` `UK2Node_AIMoveTo` and `UK2Node_PlayMontage` surfaces, preserving visible factory pins plus delegate exec/data outputs while leaving engine-hidden setup such as `WorldContextObject` outside the authored contract.
- `K2.ClassCast`, `K2.GetClassDefaults`, `K2.LoadAsset`, `K2.LoadAssetClass`, `K2.LoadAssets`, and `K2.ConvertAsset` now use explicit `TargetClassPath`, `ClassPath`, and `AssetClassPath` metadata contracts over the real `UE_5.7` node families, with end-to-end coverage for object/class/soft-reference conversion, async load authoring, class-default inspection, and class-cast execution.
